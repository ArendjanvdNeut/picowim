...
allowedHosts = Array("deltaresdata.openearth.nl", "kaart.geodan.nl","www.openlayers.org", "openlayers.org", "dev.virtualearth.net", "boomregister.geodan.nl","geoserver.nl")
...
host = GetHost(strURL)	
If false then 'TypeName(allowedHosts) <> "Nothing" And Not CheckHost(host, allowedHosts) Then
